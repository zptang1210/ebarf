...
class EventNeRFDataset_with_poses_hf_override(NGPDataset):
    ...
    def collate(self, index):
        ...
        results = {
            'H': self.H,
            'W': self.W,
            # 'rays_o': rays['rays_o'], # * rays for images are based on the original poses_hf not being overriden. should not use it!
            # 'rays_d': rays['rays_d'],
