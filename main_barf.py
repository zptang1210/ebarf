...
def get_barf_model(opt, poses_hf, intrinsics_evs, verbose=True): 
...
if __name__ == '__main__':
    ...
    model = get_barf_model(opt, train_dataset.get_poses_hf(), train_dataset.intrinsics_evs) # todo: still need to deal with optimizer and model parameters.
